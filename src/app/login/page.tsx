...
function LoginContent() {
  ...
  return (
    <>
      {error && (
        <div className="p-3 bg-loss/10 border border-loss/30 rounded-lg text-loss text-sm text-center">
...
function LoginFallback() {
  return (
    <div className="space-y-4">
      <div className="w-full h-12 bg-surface animate-pulse rounded-lg" />
      <div className="w-full h-12 bg-surface animate-pulse rounded-lg" />
    </div>
  );
}
...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-background">
      <Link href="/" className="mb-8 text-2xl font-bold flex items-center gap-2">
